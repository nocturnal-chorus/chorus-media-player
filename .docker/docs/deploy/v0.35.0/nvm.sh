...
nvm_get_mirror() {
  case "${1}-${2}" in
    # node-std) nvm_echo "${NVM_NODEJS_ORG_MIRROR:-https://mirrors.tuna.tsinghua.edu.cn/nodejs-release/}" ;;
    node-std) nvm_echo "https://mirrors.tuna.tsinghua.edu.cn/nodejs-release/" ;;
